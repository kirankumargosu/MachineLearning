...
# models together. In todays lesson you will practice using ensemble methods.
...
# The snippet below demonstrates how you can use the Random Forest algorithm (a bagged ensemble of decision trees) on
